...
class ArgsNameTest {
    ...
    void whenStringDoesNotContainKeyThenExceptionThrown3() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-=Privet"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-=Privet' does not contain a key");
    }
    ...
    void whenThereNoEqualSignThenExceptionThrown2() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-request:Hello"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
    ...
    void whenNoHyphenPrefixThenExceptionThrown2() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "request=Exit"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
